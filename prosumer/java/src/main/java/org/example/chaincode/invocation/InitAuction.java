...
public class InitAuction {
	...
	public static void main(String args[]) {
		try {
			...
			request.setFcn("initAuction");
			//   0       1       2           3                         4           5       6   7
			// "p_out", "p_s", "p_b"   "prosumerNum_total"   retailerNum_total    lambda   mu   theta
			String[] arguments = { "0.0", "0.0", "0.0", "50","3", "0.99" ,"0.53", "0.0001"}; // for testing, set num_total to 0
			...
			for (ProposalResponse res: responses) {
				...
				Logger.getLogger(InitAuction.class.getName()).log(Level.INFO,"Invoked createCar on "+Config.CHAINCODE_1_NAME + ". Status - " + status);
			}
